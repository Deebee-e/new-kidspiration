...
export const variants = {
  ...
  'primary-outline': 'bg-white text-green border-green',
  ...
  (
    ...
    return (
      <button
        ...
        type={type}
        className={clsx(
          ' border border-gray-300 disabled:opacity-70 disabled:cursor-not-allowed py-4 rounded-xl shadow-sm font-medium focus:outline-none hover:opacity-80',
          variants[variant],
          sizes[size],
          className
        )}
